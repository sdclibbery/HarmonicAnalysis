...
testRuleH89 = TestLabel "ruleH89" $ TestList
  ...
  , test [Error (Harmony 89) (Source 1 2) "Dissonance Major7"]            $ Music [r, c, b, r]
...
--  , test [Error (Harmony 89) (Source 0 0) "Dissonance Major7"]            $ Music [Beat (Note $ C Nat 4) [B Nat 4]]
--  , test [Error (Harmony 89) (Source 0 0) "Dissonance Major7"]            $ Music [Beat Rest [C Nat 4, B Nat 4]]
  ] where
